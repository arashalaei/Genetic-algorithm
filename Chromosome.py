...
class Chromosome:
    ...
    def __init__(self, _map ,type) -> None:
        self.__map = _map
        self.__string = list()
        self.__fitness = 0
        self.__create()
        self.__calc_fitness(type)
    ...
    def set_string(self, type, new_string: list) -> None:
    ...
    def mutate(self, type, possibility = 0.1):
        l = []
        if possibility == 0.1:
    ...
    def __calc_fitness(self, _win_mode_) -> None:
        path = location = 1
        score = max_path = 0
        __win__ = True
